# Canvas 射击小游戏
在第五章中，我们学会了如何在 JavaScript 中运用面向对象来开发，也学习了如何使用 Canvas 来绘制各种图案和制作游戏动画。接下来，需要大家至今所学的`面向对象开发` 和 `Canvas` 相互结合起来，来完成接下来的 `Canvas 射击小游戏`。
...
[游戏基础版（只有一关）在线演示地址](http://coding.imweb.io/shooting-game/index.html#base)
...
## 加分项
加分项内容为可选任务，如果完成了基础任务的同学，有兴趣和精力可以投入加分项的开发。
